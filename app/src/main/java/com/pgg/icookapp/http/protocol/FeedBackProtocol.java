 ...
 */
public class FeedBackProtocol extends BaseProtocol<Integer> {

    private String userId,suggestion;
    public FeedBackProtocol(String userId, String suggestion){
        this.userId=userId;
    ...
    public String getKey() {
        return "user/userSuggestion.do";
    }

    @Override
    public String getParam() {
        return "apptype=0&userId="+userId+"&suggestion="+suggestion;
    }
