 ...
 */
public class UnCollectProtocol extends BaseProtocol<Integer> {


    //http://39.108.2.139/online/job/unFavorite.do?userId=5b4ea936-60c8-4466-b97b-efbf5fc64edc&jobId=46fa0403-b8eb-496c-97aa-9a7a4fde03c2
    private String userId,jobId;
    public UnCollectProtocol(String userId, String jobId){
        this.userId=userId;
        this.jobId=jobId;
    }
    @Override
