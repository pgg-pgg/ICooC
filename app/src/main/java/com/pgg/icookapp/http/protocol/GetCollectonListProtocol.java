 ...
 */
public class GetCollectonListProtocol extends BaseProtocol<ArrayList<JobInfo>> {
    private int page;
    private String userId;
    public GetCollectonListProtocol(int page,String userId){
        this.page=page;
        this.userId=userId;
    }
    @Override
    ...
    public String getParam() {
        return "size=6&page="+page+"&userId="+userId+"&type=2";
    }
